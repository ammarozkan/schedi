...
//#define SCHEDI_LOG_NAMED_THREADS 1 	// Enables naming threads to make 
					// them more human readable.
					// Also spends extra instructions 
					// on selecting names and comparing
...
// events should point to a buffer that's at least SCHEDI_FLOG_SIZE elements
// long. events[SCHEDI_FLOG_SIZE-1] will be the last event. If events are full,
// events[0] would be the oldest event that is still saved.
